      ...
      <el-col>
        ...
        <div>
          <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark">
            ...
            <el-table-column prop="belong" label="属于" show-overflow-tooltip> </el-table-column>
    ...
    methods: {
      fetch(scence) {
        if ('list' == scence) {
          ...
          Interface.getData('get', Interface.website.frontend.get,params).then(res => {
      ...
      destory(row) {
        ...
        this.$confirm('是否确定要删除?', '提示', {
          ...
          Interface.getData('post', Interface.website.frontend.delete + '/' + row.id, param).then(res => {
            if (res.data.code == 200) {
